...
namespace Azure.ResourceManager.Core
{
    ...
    /// </summary>
    public class GenericResourceData : TrackedResource<ResourceManager.Resources.Models.GenericResource, NewResourceIdentifier>
    {
        /// <summary>
        ...
        public GenericResourceData(NewResourceIdentifier id)
        ...
        public GenericResourceData(NewResourceIdentifier id, LocationData location)
            : base(id, location, null)
        {
        }

        /// <inheritdoc/>
        public override NewResourceIdentifier Id { get; protected set; }
