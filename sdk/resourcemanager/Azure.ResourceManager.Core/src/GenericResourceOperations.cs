...
namespace Azure.ResourceManager.Core
{
    ...
    /// </summary>
    public class GenericResourceOperations : ResourceOperationsBase<NewResourceIdentifier, GenericResource>, ITaggableResource<NewResourceIdentifier, GenericResource>, IDeletableResource
    {
        ...
        internal GenericResourceOperations(ResourceOperationsBase<NewResourceIdentifier> operations, NewResourceIdentifier id)
            : base(operations, id)
        {
